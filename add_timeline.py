...
for _y, _mn in _months_set:
    ...
    _cal_blocks.append(f'<div class="tl-cal"><div class="tl-cal-title">{_y}年{_mn}月<span class="total">{_month_cases}試験 ／ {_month_days}日間</span></div><div class="tl-cal-grid">{_heads}{chr(10).join(_cells)}</div></div>')
